...
// Ensure default accordion step 1 title matches new spec
document.addEventListener('DOMContentLoaded', () => {
    const _defaultStepTitle = document.getElementById('journeyStepTitle');
    if (_defaultStepTitle) _defaultStepTitle.textContent = 'Consultation & Custom Plan';
});

// Default accordion step 1 title
const _defaultStepTitle = document.getElementById('journeyStepTitle');
if (_defaultStepTitle) _defaultStepTitle.textContent = 'Consultation & Custom Plan';
...
function drawRouteMap() {
    ...
    const routes = [
        { x: 100, y: 200, label: "Bangalore", color: "#e5a93c" },
